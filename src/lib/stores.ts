...
import type { LocalPlayer, Game, ChatMessage, GameListItem } from "./types";
...
/** Local player identity (id, name) -- persisted across page navigation */
export const currentPlayer = persistedStore<LocalPlayer | null>(
	"wg_player",
	null,
);
